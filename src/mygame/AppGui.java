...
public class AppGui {
    ...
    public AppGui(Main app)
    {
        ...
        this.startButton.setPosition(0, app.getMySettings().getHeight()/2 - app.getMySettings().getHeight()/10);
        ...
        this.PauseButton.setLocalTranslation(0, app.getMySettings().getHeight()+ app.getMySettings().getHeight()/10, -1);
        ...
        this.resumeButton.setPosition(0, app.getMySettings().getHeight() + app.getMySettings().getHeight()/10);
        
        this.towerButton = new Picture("towerButton");
        this.towerButton.setImage(app.getAssetManager(), "/Boutons/Buttonstart.png", true);
